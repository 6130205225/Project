        ...
        <div class="lg:ml-24 lg:mr-24 m-10 ">
            <label class="block">
                ...
                <input type="text" name="activity_name"
                    class="form-input mt-1 block w-full border py-3" placeholder="กรุณากรอกชื่อกิจกรรม">
            </label>
            ...
            <label class="block mt-6">
                ...
                <textarea class="form-textarea mt-1 block w-full border" name="activity_description"
                 rows="15" placeholder="กรุณากรอกรายละเอียดกิจกรรมของวัด"></textarea>
            </label>
